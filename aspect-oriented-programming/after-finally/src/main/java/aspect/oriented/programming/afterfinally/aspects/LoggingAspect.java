package aspect.oriented.programming.afterfinally.aspects;
...
public class LoggingAspect {
    ...
    @After("execution(* aspect.oriented.programming.afterfinally.dao.AccountDAO.findAccounts(*))")
    ...
    @AfterThrowing(
            pointcut = "execution(* aspect.oriented.programming.afterfinally.dao.AccountDAO.findAccounts(*))",
            throwing = "e"
    )
